      ...
      <div className="Hero inline-flex h-80 w-[550px] flex-col items-center justify-start gap-5">
        <div className="HeroContent relative h-[252px] w-[550px]">
              ...
              >
                <div className="HeroContent absolute left-0 top-0 inline-flex w-[550px] flex-col items-center justify-center gap-4">
                  <div className="Div inline-flex shrink grow basis-0 flex-col items-center justify-center gap-4 self-stretch">
                    <div className="ProjectTitle w-[270px] text-center text-[64px] font-bold leading-[73px] text-white">
                      GraphID
                    </div>
                    <div className="Slogan text-[32px] font-semibold text-white">
                      Your Digital Universe, Mapped Out
                    </div>
                  </div>
                  <div className="MisionStatement w-[461px] text-center text-base font-normal leading-normal tracking-wide text-white">
                    Reimagine how you share, manage, and visualize your digital
                    data across Web2 and Web3
                  </div>
                </div>
              </motion.div>
            )}
          ...
          <motion.div
            initial={{ scale: 1, y: 0 }}
            animate={{
              scale: isInputFocused ? 1.5 : 1,
              y: isInputFocused ? -50 : 0
            }}
            transition={{ duration: 0.5 }}
          >
            <input
        ...
        <AnimatePresence>
          {!isInputFocused && (
            ...
            >
              ...
              >
                <div className="Continue text-base font-medium leading-normal text-black">
                  Connect
                </div>
              </div>
            </motion.div>
